...
@section('content')
    ...
    <header class="masthead"
        style="background-image: url('asset/img/x2/pascal-muller-iSz0IMtulos-unsplash@2x.png'); height:25rem;">
        ...
        <div class="container px-2 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-left">
                <div class="col-md-6">
                    ...
                    <P>Lorem ipsum dolor sit amet, consectur adipiscing elit, sed do <br>
                        eiusmod tempor incididunt ut labore et dolore magna aliqua. <br>
                        Ut enim ad minim veniam, quis nostrud exercitation ullamco <br>
                        laboris nisi ut aliquip ex ea commodo consequent. Duis aute <br>
                ...
                <div class="col-md-6 ">
                    <div class="row">
                        <div class="col-md-6">
                            <img src="{{ asset('asset/img/x2/kyaw-tun-_YIX48_4hgs-unsplash@2x.png') }}" width="97%"
                                height="">
                        </div>
                        <div class="col-md-6">
                            <img src="{{ asset('asset/img/x2/dawn-armfield-84n7c9cLEKM-unsplash@2x.png') }}" width="99%"
                                height="99%">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <img src="{{ asset('asset/img/x2/smit-patel-dGMcpbzcq1I-unsplash@2x.png') }}">
                    </div>
                </div>
            </div>
        </div>
