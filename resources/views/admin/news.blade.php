            ...
            <div class="row gx-4 gx-lg-5 justify-content-left">
                ...
                <div class="col-md-6">
                    <table class="table table-borderless">
                        <tr>
                            <td rowspan="2">
                                <img src="{{ asset('asset/img/x2/zoe-reeve-9hSejnboeTY-unsplash@2x.png') }}"
                                    style="height: 29rem">
                            </td>

                            <td>
                                <img src="{{ asset('asset/img/x1/ronald-gijezen-7h06P9UKhYY-unsplash.png') }}"
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('asset/img/x1/david-clode-AtCChdVhAmA-unsplash.png') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div style="background-color: rgb(245, 238, 238)">
                                <img class="card-img-top"
                                    src="{{ asset('asset/img/x2/ronald-gijezen-7h06P9UKhYY-unsplash@2x.png') }}"
                                    alt="Card image cap">
                                <div class="card-body">
                                    <p class="card-text">
                                        <center>
