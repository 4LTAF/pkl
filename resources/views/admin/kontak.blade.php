    ...
    <div class="container">
        ...
        <main class="mb-4">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <img src="{{ asset('asset/img/x1/1_qYUvh-EtES8dtgKiBRiLsA.png') }}" alt="" style="width: 100%;">
            </div>
        </main>
        {{-- End Main Maps --}}
        ...
        {{-- Form --}}
        <form action="{{ route('Kontak.store') }}" class="contact-form" method="post" id="form">
            @csrf

            <div class="row">
                <div class="col-md-8">
                    <div class="form-grup">
                        <textarea class="form-control textarea-contact" rows="11" id="comment" name="des"
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <input type="text" class="form-control form-control-lg" id="subject" name="sub"
